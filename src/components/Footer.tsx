...
export default function Footer() {
  return (
    <footer className="bg-[#0D0A1A] text-white border-t border-white/6">
        ...
        <div className="grid lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2.5">
              <a href="mailto:soporte@mawi.io" className="flex items-center gap-2 text-white/35 hover:text-white/70 text-sm transition-colors">
                <Mail size={13} />
                soporte@mawi.io
              </a>
          ...
          {Object.entries(links).map(([section, items]) => (
            <div key={section}>
              <h4 className="text-white/50 font-semibold text-xs uppercase tracking-[0.1em] mb-4">{section}</h4>
