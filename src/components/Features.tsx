...
import {
  ...
  Bell, Users, Calendar, CheckSquare, ArrowRight
} from "lucide-react";
...
export default function Features() {
  ...
  return (
    <section id="funcionalidades" className="section-pad-lg bg-[#0D0A1A] relative" ref={ref}>
      <div className="absolute inset-0 bg-dots opacity-25" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#FF4E00] opacity-[0.04] blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="container-xl relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#FF4E00]/10 border border-[#FF4E00]/20 rounded-full px-4 py-1.5 mb-5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#FF4E00]" />
            <span className="text-[#FF4E00] text-xs font-semibold uppercase tracking-wider">Funcionalidades</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
          {features.map((feat, i) => (
            ...
            >
              ...
              <h3 className="text-white font-semibold text-[17px] mb-2 leading-snug">{feat.title}</h3>
